...
Desktop clients connect directly to this backend for RPC commands and SSE invalidations. TanStack
Start owns browser authentication routes only and does not proxy either backend interface.
