...
import { SnippetHydrationError } from "./SnippetHydration.ts";
...
export const makeSnippetHydrationTransportLive = (fetch: SnippetFetch) =>
  Layer.effect(
...
export const SnippetHydrationTransportLive = makeSnippetHydrationTransportLive((input, init) =>
